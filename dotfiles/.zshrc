...
export PATH=$PATH:/usr/local/Adobe/Reader9/bin/:/usr/local/adt/sdk/tools/:/home/chris/bin:/usr/local/heroku/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/home/chris/.rvm/bin:/home/chris/code/ghub/tools/:/usr/local/adt/sdk/platform-tools:/usr/local/eclipse/
